...
FIGURES_HOME = base_path + "Checkpoints/"  # for storing visualizations
CORPORA_HOME = base_path + "German_corpora/"  # location of Wikipedia corpora
MSR_COMP_HOME = base_path

UD_HOME = "/u/scr/mhahn/FAIR18/UD/"
