...
#print(similarity("dog",  "beer"))
#print(similarity("wine", "beer"))
#print(similarity("cat", "cats"))
#print(similarity("computer", "cats"))
#print(similarity("computer", "jerry"))
#print(similarity("computer", "mouse"))
#print(similarity("computer", "laptop"))
#
#
#
...
for _ in range(100):
  ...
  encodedNounsInN = [encodeWord(x) for x in nounsInNSelected]
  encodedVerbsInN = [encodeWord(x) for x in verbsInNSelected]
 
  #print(encodedNounsInN) 
